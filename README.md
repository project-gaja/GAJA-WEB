...
|팀원|담당역할 및 구현기능|
|:---:|:---|
|![환희](https://user-images.githubusercontent.com/101374824/173772634-9fbb859c-16f5-4cce-8ea1-25b57417554d.jpg)|- **최환희** <br>- 프로젝트 매니저 <br>- 연차관리 개발 (연차 현황 및 조회, 부여) <br>- 근태관리 개발 (nfc태그를 통해 출근을 등록)|
...
|![김우연](https://user-images.githubusercontent.com/101374824/173772624-cddbe5c6-eaec-44f2-918d-ac400ff122c6.jpg)|- **김우연** <br>- DB관리자 <br>- 일정관리 개발(일정등록/수정/삭제/조회) <br>- 알림 개발 (전자결재 또는 공지사항 알림) <br>- 회의실예약 개발 (회의실 예약/조회/수정/삭제,회의실 등록) <br>- CI/CD 배포환경 구축|
