...
|팀원|담당역할 및 구현기능|
|:---:|:---|
|![환희](https://user-images.githubusercontent.com/101374824/173772634-9fbb859c-16f5-4cce-8ea1-25b57417554d.jpg)|- **환희** <br>- 프로젝트 매니저 <br>- 연차관리 개발 (연차 현황 및 조회, 부여) <br>- 근태관리 개발 (nfc태그를 통해 출근을 등록)|
